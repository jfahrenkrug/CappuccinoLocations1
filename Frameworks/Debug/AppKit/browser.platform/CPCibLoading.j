I;21;Foundation/CPBundle.jI;25;Foundation/CPDictionary.jI;21;Foundation/CPString.jc;4222;
...
{ with(self)
{
    objj_msgSend(objj_msgSend(objj_msgSend(CPCib, "alloc"), "initWithCibNamed:bundle:", aFileName, self), "instantiateCibWithExternalNameTable:", aNameTable);
}
},["void","CPString","CPDictionary","id"]), new objj_method(sel_getUid("loadCibFile:externalNameTable:loadDelegate:"), function $CPBundle__loadCibFile_externalNameTable_loadDelegate_(self, _cmd, aFileName, aNameTable, aDelegate)
{ with(self)
{
